...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/smatsuo/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["norminette42.nvim"] = {
    loaded = true,
    path = "/Users/smatsuo/.local/share/nvim/site/pack/packer/start/norminette42.nvim",
  ...
  ["tokyodark.nvim"] = {
    loaded = true,
    path = "/Users/smatsuo/.local/share/nvim/site/pack/packer/start/tokyodark.nvim",
